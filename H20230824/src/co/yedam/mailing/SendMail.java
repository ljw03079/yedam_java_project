...
//https://blog.naver.com/devjay_/222978951150
//환경설정
...
public class SendMail {
	...
	final String FROM = "ljw03079@naver.com";
	final String PASS = "hm05070472**";

	public Session setting() {
		Properties props = new Properties();//key, value 다 문자열(map)
